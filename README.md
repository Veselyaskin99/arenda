...
### Функционал:
- Выводит статистику арендованных ТС;
- Выводит статистику вырученных денег за аренду ТС;
- Выводит статистику по клиентам (сколько раз он арендовал машину);
- Выводит статистику по менеджерам (сколько машин он сдал в аренду);
- Выводит статистику по чистой прибыли(- 20%(налоги))
